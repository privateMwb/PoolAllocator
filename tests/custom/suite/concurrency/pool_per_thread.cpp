...
static void independent_pools_no_shared_addresses() {
...
static void per_thread_pool_independent() {
...
static void pools_created_destroyed_safe() {
    std::vector<bool> allCorrect(kThreads, true);
    std::vector<std::thread> threads;
...
static void run_tests() {
    RUN(independent_pools_no_shared_addresses);
    RUN(per_thread_pool_independent);
    RUN(pools_created_destroyed_safe);
}
