...
static void concurrent_alloc_no_double_issue() {
...
static void concurrent_dealloc_reclaims_exact() {
    Pool<> pool(sizeof(void*), kThreads * kPerThread);
    std::mutex poolMutex;
...
static void concurrent_alloc_batch_consistent() {
...
static void run_tests() {
    RUN(concurrent_alloc_no_double_issue);
    RUN(concurrent_dealloc_reclaims_exact);
    RUN(concurrent_alloc_batch_consistent);
}
