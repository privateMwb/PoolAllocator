...
static void create_destroy_frees_slot() {
...
static void repeated_churn_no_leak() {
...
static void partial_destroy_frees_targeted_slot() {
...
static void run_tests() {
    RUN(create_destroy_frees_slot);
    RUN(repeated_churn_no_leak);
    RUN(partial_destroy_frees_targeted_slot);
}
