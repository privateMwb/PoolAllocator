...
static void freelist_preferred_over_watermark() {
...
static void watermark_never_exceeds_capacity() {
...
static void batch_single_share_consistent_freelist() {
...
static void run_tests() {
    RUN(freelist_preferred_over_watermark);
    RUN(watermark_never_exceeds_capacity);
    RUN(batch_single_share_consistent_freelist);
}
