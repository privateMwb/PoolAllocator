...
// the first fill.
static void full_cycle_after_reset_matches() {
...
// watermark capacity.
static void reset_partial_use_discards_freelist() {
    Pool<> pool(sizeof(void*), 4);
...
static void run_tests() {
    RUN(full_cycle_after_reset_matches);
    RUN(reset_partial_use_discards_freelist);
