...
static void batch_drains_partial_advances_watermark() {
...
static void batch_drains_freelist_watermark_exhausted() {
...
// has ever been freed.
static void batch_drains_virgin_memory_empty_freelist() {
...
static void run_tests() {
    RUN(batch_drains_partial_advances_watermark);
    RUN(batch_drains_freelist_watermark_exhausted);
    RUN(batch_drains_virgin_memory_empty_freelist);
}
