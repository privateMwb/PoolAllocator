...
static void skips_destructor_on_teardown() {
...
static void skips_destructors_outstanding_objects() {
...
static void teardown_mixed_free_used_safe() {
...
static void run_tests() {
    RUN(skips_destructor_on_teardown);
    RUN(skips_destructors_outstanding_objects);
    RUN(teardown_mixed_free_used_safe);
}
