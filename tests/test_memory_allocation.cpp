...
// Single Allocation
// Verifies that allocating one block updates the pool state correctly.
...
// Verifies that allocation fails once all blocks have been consumed.
...
// Deallocate Returns Block
// Verifies that a deallocated block is returned to the free list.
...
// Deallocate nullptr
// Verifies that deallocating a null pointer has no effect.
...
// Pointer Reuse After Deallocate
...
// Batch Allocate
// Verifies that multiple blocks can be allocated in a single operation.
...
// Batch Deallocate
// Verifies that multiple blocks can be returned to the pool at once.
